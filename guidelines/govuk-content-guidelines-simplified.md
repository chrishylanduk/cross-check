# GOV.UK Content Guidelines (Simplified)
...
**Good example** — At the activity centre you can:

- swim
- play
- run

**Bad example** — At the activity centre:
...
You can use abbreviations without explaining them if they're well known. If the abbreviation is not well known, write it out in full if you use it in a title. For example, 'Personal Independence Payment (PIP)'.
...
- **Bad:** Hazardous waste — new process
- **Good:** How to dispose of hazardous waste in your area
...
- **Bad:** Using and submitting your business expenses
- **Good:** Submitting your business expenses

### Using 'ing' in titles

Use the active verb ('Submit') if you use the page to do the thing.

- **Good form title:** Submit your business expenses

Use the present participle ('Submitting') if the page is about doing the thing, but you do it elsewhere.

- **Good guidance title:** Submitting your business expenses
...
- **Bad:** Consultation on furniture fire safety regulations
- **Good:** Amendments to furniture fire safety regulations
- **Bad:** Potato guidance
- **Good:** How to grow potatoes
...
- Government annual report 2020
- Government annual report 2019
- Government annual report 2018
...
**Example:** Highways Agency environmental strategy
...
- **Bad:** Implementing the government's strengthened approach to budget support: technical note
- **Good:** How the government is making budget support more effective in countries supported by the UK
